...
VALUES ('Chuteira Nike Superfly 9 Club Futsal',
       ...
       ('Regata Nike Dri-FIT ADV AeroSwift Masculina',
        ...
        499.99, 11,
        0, 1, NOW()),
       ('Chuteira Nike Phantom GT Society',
        'Continuando o legado da Phantom GT, a Nike Jr. Phantom GTTF apresenta um design atualizado e um padrão projetado para ajudar a posicionar a bola com uma precisão incomparável. Os cadarços descentralizados criam uma zona de chute livre de obstáculos para chutes, passes e dribles precisos.',
        379.99, 120,
        0, 1, NOW());
